#!/usr/bin/python3
"""unittest cases for the user model class"""
...
class TestUserModel(unittest.TestCase):
    '''the class of test cases for the user model class'''
    ...
    def test_id_uniqueness(self):
        ...
        """
        instances = [User() for _ in range(5)]
    ...
    def test_default_str_output(self):
        """
        Test the default __str__ output of the User class.
        """
        obj = User()
        str_output = str(obj)
